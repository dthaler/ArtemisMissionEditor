...
namespace ArtemisMissionEditor
{
    ...
    public sealed partial class Settings
    {
        ...
        public void BindsBrush_LoadDefaults()
        {
            ...
            _bindsBrushColor.Add(MapColors.PurpleNebula,            Color.FromArgb(32, 255, 0, 255));
            _bindsBrushColor.Add(MapColors.PurpleNebulaBG,            Color.FromArgb(16, 255, 0, 255));
            _bindsBrushStyle.Add(MapColors.PurpleNebulaBG,            HatchStyle.Percent10);
            _bindsBrushColor.Add(MapColors.BlueNebula,              Color.FromArgb(32, 0, 0, 255));
            _bindsBrushColor.Add(MapColors.BlueNebulaBG,            Color.FromArgb(16, 0, 0, 255));
            _bindsBrushStyle.Add(MapColors.BlueNebulaBG,            HatchStyle.Percent10);
            _bindsBrushColor.Add(MapColors.YellowNebula,            Color.FromArgb(32, 255, 255, 0));
            ...
            for (; _version++ < LastVersion; )
            {
                ...
                switch(_version)
                {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        // Rename Nebula and NebulaBG
                        if (!_bindsBrushColor.Keys.Contains(MapColors.BlueNebula))
                        {
                            // Add BlueNebula and BlueNebulaBG
                            _bindsBrushColor.Add(MapColors.BlueNebula, Color.FromArgb(32, 0, 0, 255));
                            _bindsBrushColor.Add(MapColors.BlueNebulaBG, Color.FromArgb(16, 0, 0, 255));
                            _bindsBrushStyle.Add(MapColors.BlueNebulaBG, HatchStyle.Percent10);

                            // Add YellowNebula and YellowNebulaBG
                            _bindsBrushColor.Add(MapColors.YellowNebula, Color.FromArgb(32, 255, 255, 0));
                            _bindsBrushColor.Add(MapColors.YellowNebulaBG, Color.FromArgb(16, 255, 255, 0));
                            _bindsBrushStyle.Add(MapColors.YellowNebulaBG, HatchStyle.Percent10);
                        }
